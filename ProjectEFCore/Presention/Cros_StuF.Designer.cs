namespace ProjectEFCore.Presention
{
    partial class Cros_StuF
    {
        ...
        private void InitializeComponent()
        {
            ...
            // St_Id
            // 
            St_Id.BackColor = SystemColors.ActiveCaption;
            St_Id.Font = new Font("Microsoft Uighur", 15F, FontStyle.Regular, GraphicsUnit.Point, 0);
            St_Id.ForeColor = Color.Navy;
            St_Id.Location = new Point(762, 180);
            St_Id.Margin = new Padding(3, 4, 3, 4);
            St_Id.Multiline = true;
            St_Id.Name = "St_Id";
            St_Id.PlaceholderText = "St_Id";
            St_Id.Size = new Size(277, 48);
            St_Id.TabIndex = 40;
            // 
            // Crs_Id
            // 
            ...
            Crs_Id.Location = new Point(762, 349);
            Crs_Id.Margin = new Padding(3, 2, 3, 2);
            Crs_Id.Multiline = true;
            Crs_Id.Name = "Crs_Id";
            Crs_Id.PlaceholderText = "Cros_Id";
            ...
            btnDelete.Location = new Point(553, 572);
            ...
            btnUpdate.Location = new Point(292, 572);
            ...
            btnInsert.Location = new Point(50, 572);
            ...
            dataGrid.Location = new Point(50, 59);
